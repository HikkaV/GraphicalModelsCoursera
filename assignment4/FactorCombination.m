% FactorCombination Computes the combination of two factors.
%   C = FactorProduct(A,B) computes the combaniation of two factors, A and B,
...
%
%   See also FactorProduct, FactorMarginalization.m, IndexToAssignment.m, and
%   AssignmentToIndex.m
%

function C = FactorCombination(A, B)

% Check for empty factors
if (isempty(A.var)), C = B; return; end;
if (isempty(B.var)), C = A; return; end;

%%%%%%%%%%%%%%%%%%% no need for A and B to have common variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%
